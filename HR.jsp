...
<DIV>
<table width="80%" border="2px">
<caption>ALL UNAPPROVED EMPLOYEES</caption>
<tr>
<th>ID</th>
<th>NAME</th>
<th>EMAIL</th>
...
<c:forEach var="emp" items="${requestScope.ulist}">
<tr>
<td><c:out value="${emp.id}"></c:out></td>
<td><c:out value="${emp.name}"></c:out></td>
<td><c:out value="${emp.email}"></c:out></td>
...
<td><c:out value="${emp.role}"></c:out></td>
<td><c:out value="${emp.active}"></c:out></td>
<td><a href="./ApproveUser?empid=${emp.id}">Approve</a></td>
<td><a href="./DeleteUser?empid=${emp.id}">Delete</a></td>
</tr>
</c:forEach>
</table>
</DIV>
